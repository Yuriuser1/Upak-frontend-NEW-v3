...
const faqs = [
  {
    ...
    answer: 'UPAK — это сервис подготовки карточек товаров под ключ для Wildberries, Ozon и Яндекс Маркета: фото, текст, преимущества, характеристики, визуальная логика и файлы для работы.',
  },
  {
    question: 'Как быстро будет готов результат?',
    answer: 'Бесплатный preview можно подготовить быстро. Полная карточка под ключ выполняется после согласования фото, количества SKU, состава результата и срока, потому что включает ручную проверку.',
  },
  {
    question: 'Можно ли загрузить фото товара?',
    answer: 'Да. Для формата под ключ фото являются обязательной частью брифа: главное фото, детали, упаковка, состав, размеры и референсы. На сайте и в Telegram нужно развивать полноценный прием фото и статусы обработки.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Результат согласуется заранее: PDF для согласования, ZIP с фото/визуальными материалами, XLSX/CSV для работы с карточкой, текстовые поля, характеристики и список рисковых формулировок.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Платный заказ оформляется после согласования задачи и состава результата. В полноценной реализации оплата должна быть привязана к конкретному заказу и запускать его в работу.',
  },
  {
